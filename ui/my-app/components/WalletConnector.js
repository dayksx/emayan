...
const THEMES = {
  dark: {
    "--xc-background-color": "#0c1019",
    "--xc-background-secondary": "#141a26",
    "--xc-background-tertiary": "#1c2433",
    "--xc-text-color": "#f1f5f9",
    "--xc-text-muted-color": "rgba(148, 163, 184, 0.85)",
    "--xc-primary-color": "#2dd4bf",
  },
  light: {
  ...
  return (
    <xrpl-wallet-connector
      ...
      style={{
        ...
        "--xc-modal-box-shadow": "0 24px 64px rgba(0, 0, 0, 0.55)",
      }}
